...
{
#if VBE
    public class CustomVbeScreen : Canvas
    {
        private static readonly Mode DefaultMode = new Mode(320, 240, ColorDepth.ColorDepth32);

        /// <summary>
        /// Driver for Setting vbe modes and ploting/getting pixels
        /// </summary>
        private protected readonly CustomVbeDriver Driver;

        private Mode _mode;

        public CustomVbeScreen()
            : this(DefaultMode)
        {
        }

        public CustomVbeScreen(Mode mode)
            : base(mode)
        {
            ...
            Driver = new CustomVbeDriver((ushort)mode.Columns, (ushort)mode.Rows, (ushort)mode.ColorDepth);
        }
        ...
        protected override Mode getDefaultGraphicMode() => DefaultMode;
        ...
        public override void DrawPoint(Pen pen, int x, int y)
        {
            ...
            switch (Mode.ColorDepth)
            {
                case ColorDepth.ColorDepth32:
                    ...
                    Driver.SetVram(offset, (uint)color.ToArgb());
                ...
                case ColorDepth.ColorDepth24:
                    ...
                    offset = (uint)GetPointOffset(x, y);
                    Global.mDebugger.SendInternal($"Drawing Point of color {color} at offset {offset}");
                    Driver.SetVram(offset, (((uint)color.R * 1000 + color.G) * 1000 + color.B));
        ...
        public override void DrawFilledRectangle(Pen pen, int x, int y, int width, int height)
        {
            ...
            {
                Driver.ClearVram((i * xScreenWidthInPixel) + xOffset, width, pen.Color.ToArgb());
            }
        }
        ...
        public override void DrawImage(Image image, int x, int y)
        {
            ...
            {
                Driver.CopyVram((i * xScreenWidthInPixel) + xOffset, xBitmap, (i * xWidht), xWidht);
            }
        ...
        public override Color GetPointColor(int x, int y)
        {
            ...
            return Color.FromArgb(Driver.GetVram(offset));
        }
